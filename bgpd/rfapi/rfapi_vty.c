...
void rfapi_vty_init ()
{
  ...
  install_element (RESTRICTED_NODE, &vnc_show_summary_cmd);
  install_element (VIEW_NODE, &vnc_show_nves_cmd);
  install_element (RESTRICTED_NODE, &vnc_show_nves_cmd);
  install_element (VIEW_NODE, &vnc_show_nves_ptct_cmd);
  install_element (RESTRICTED_NODE, &vnc_show_nves_ptct_cmd);
